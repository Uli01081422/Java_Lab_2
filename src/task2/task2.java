...
public class task2 {
    public static University create (){
        ...
        final Student student1 = new Student(" Andriy Perun ", 26, studySchedule1, journal2, group1);
        final Student student2 = new Student("Anton Yosypovych", 28, studySchedule2, journal1, group2);
        ...
        studySchedule2.setSchedule(Stream.of(
                ...
                new ScheduleItem(Stream.of(LocalDate.of(2022, 3, 7)).collect(Collectors.toList()), subject3)
        ).collect(Collectors.toList()));
